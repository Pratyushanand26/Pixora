    ...
    return (
        ...
        <Card className="w-[350px] px-4">
            ...
            <CardContent>
                <div className="grid w-full items-center gap-4">
                    <div className="flex flex-col space-y-1.5">
                        ...
                        <Input onChange={(e:any) => setName(e.target.value)} id="name" placeholder="Name of the model" />
                    </div>
                    <div className="flex flex-col space-y-1.5">
                    ...
                    <div className="flex flex-col space-y-1.5">
                        ...
                        <Input id="name" placeholder="Age of the model" onChange={(e:any) => {
                    ...
                    <UploadModal onUploadDone={(zipUrl:any)=>{
                        setZipUrl(zipUrl)
                    }}/>
                </div>
            </CardContent>
            <CardFooter className="flex justify-between">
                ...
                <Button 
                    disabled={!eyeColor||!ethinicity||!zipUrl||!bald||!type||!age}
                    onClick={trainModal}
                >Create Model</Button>
            </CardFooter>
            </Card>
